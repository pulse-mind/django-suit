...
# Bootstrap 5 grid: col-* applies from xs up, col-sm-*, col-md-*, col-lg-* from each breakpoint.
# Your own suit_form_size strings must use the same vocabulary: Bootstrap 3 col-xs-* classes
# (used here up to django-suit 2.4) match no rule under Bootstrap 5 and are ignored.
SUIT_FORM_SIZE_LABEL = 'col-12 col-sm-3 col-md-2'
SUIT_FORM_SIZE_INLINE = (SUIT_FORM_SIZE_LABEL, 'col-12 col-sm-9 col-md-10 form-inline')
SUIT_FORM_SIZE_X_TINY = (SUIT_FORM_SIZE_LABEL, 'col-12 col-sm-4 col-md-3 col-lg-2')
SUIT_FORM_SIZE_TINY = (SUIT_FORM_SIZE_LABEL, 'col-12 col-sm-5 col-md-4 col-lg-3')
SUIT_FORM_SIZE_SMALL = (SUIT_FORM_SIZE_LABEL, 'col-12 col-sm-6 col-md-5 col-lg-4')
SUIT_FORM_SIZE_HALF = (SUIT_FORM_SIZE_LABEL, 'col-12 col-sm-7 col-md-6 col-lg-5')
SUIT_FORM_SIZE_LARGE = (SUIT_FORM_SIZE_LABEL, 'col-12 col-sm-8 col-md-7 col-lg-6')
SUIT_FORM_SIZE_X_LARGE = (SUIT_FORM_SIZE_LABEL, 'col-12 col-sm-9 col-md-8 col-lg-7')
SUIT_FORM_SIZE_XX_LARGE = (SUIT_FORM_SIZE_LABEL, 'col-12 col-sm-9 col-md-10 col-lg-8')
SUIT_FORM_SIZE_XXX_LARGE = (SUIT_FORM_SIZE_LABEL, 'col-12 col-sm-9 col-md-10 col-lg-9')
SUIT_FORM_SIZE_FULL = (SUIT_FORM_SIZE_LABEL, 'col-12 col-sm-9 col-md-10')
...
class DjangoSuitConfig(AppConfig):
    ...
    # ----------------------------------------------
    # suit_form_size = {
    #     'default': ('col-12 col-sm-2', 'col-12 col-sm-10'),
    #     'fields': {
